...
[{include file="_header_plain.tpl" title=$template_title location=$template_title}]
  ...
  <div class="errorbox">
      ...
      <div class="errbody">[{ oxmultilang ident="ERR_EXPIRED_DAYS_VERSIONEXPIRED1" }] <a href="http://www.oxid-esales.com">[{ oxmultilang ident="ERR_EXPIRED_DAYS_VERSIONEXPIRED2" }]</a> [{ oxmultilang ident="ERR_EXPIRED_DAYS_VERSIONEXPIRED3" }]</div>
  </div>
