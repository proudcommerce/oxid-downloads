  ...
  <div class="listitem">
      ...
      <a id="test_Top5Pic_[{$_product->oxarticles__oxid->value}]" href="[{$_product->getLink()}]" class="picture">
          <img src="[{$_product->getIconUrl()}]" alt="[{ $sTop5ArtTitle|strip_tags }]">
      </a>
      <a id="test_Top5Title_[{$_product->oxarticles__oxid->value}]" href="[{$_product->getLink()}]" class="title">[{ $sTop5ArtTitle|strip_tags}]</a>
