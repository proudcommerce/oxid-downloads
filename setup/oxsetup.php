...
class OxSetupUtils extends oxSetupCore
{
    ...
    public function checkPaths( $aParams )
    {
        ...
        $aPaths = array($aParams['sShopDir']."/config.inc.php",
                        $aParams['sShopDir']."/$sBaseOut/0",
                        $aParams['sShopDir']."/$sBaseOut/1",
                        $aParams['sShopDir']."/$sBaseOut/2",
                        $aParams['sShopDir']."/$sBaseOut/3",
                        $aParams['sShopDir']."/$sBaseOut/4",
                        $aParams['sShopDir']."/$sBaseOut/5",
                        $aParams['sShopDir']."/$sBaseOut/6",
                        $aParams['sShopDir']."/$sBaseOut/7",
                        $aParams['sShopDir']."/$sBaseOut/8",
                        $aParams['sShopDir']."/$sBaseOut/9",
                        $aParams['sShopDir']."/$sBaseOut/10",
                        $aParams['sShopDir']."/$sBaseOut/11",
                        $aParams['sShopDir']."/$sBaseOut/12",
                        $aParams['sShopDir']."/$sBaseOut/master/1",
                        $aParams['sShopDir']."/$sBaseOut/master/2",
                        $aParams['sShopDir']."/$sBaseOut/master/3",
                        $aParams['sShopDir']."/$sBaseOut/master/4",
                        $aParams['sShopDir']."/$sBaseOut/master/5",
                        $aParams['sShopDir']."/$sBaseOut/master/6",
                        $aParams['sShopDir']."/$sBaseOut/master/7",
                        $aParams['sShopDir']."/$sBaseOut/master/8",
                        $aParams['sShopDir']."/$sBaseOut/master/9",
                        $aParams['sShopDir']."/$sBaseOut/master/10",
                        $aParams['sShopDir']."/$sBaseOut/master/11",
                        $aParams['sShopDir']."/$sBaseOut/master/12",
                        $aParams['sShopDir']."/$sBaseOut/icon",
                        $aParams['sShopDir']."/$sBaseOut/z1",
                        $aParams['sShopDir']."/$sBaseOut/z2",
                        $aParams['sShopDir']."/$sBaseOut/z3",
                        $aParams['sShopDir']."/$sBaseOut/z4",
                        $aParams['sShopDir']."/$sBaseOut/z5",
                        $aParams['sShopDir']."/$sBaseOut/z6",
                        $aParams['sShopDir']."/$sBaseOut/z7",
                        $aParams['sShopDir']."/$sBaseOut/z8",
                        $aParams['sShopDir']."/$sBaseOut/z9",
                        $aParams['sShopDir']."/$sBaseOut/z10",
                        $aParams['sShopDir']."/$sBaseOut/z11",
                        $aParams['sShopDir']."/$sBaseOut/z12",
                        $aParams['sShopDir']."/out/basic/src/bg",
                        $aParams['sShopDir']."/out/basic/src",
